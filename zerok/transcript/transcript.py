...
from zerok.utils.curve import Scalar, G1Point
from zerok.transcript.merlin.merlin_transcript import MerlinTranscript
from zerok.polynomials.field import (
    FiniteField,
    ModularInteger,
    PRIME_MODULO as curve_order,
)
from zerok.polynomials.field import float_to_mod_float
from typing import Optional
import dill
from zerok.types.proof import Proof
